#!/usr/bin/python2
#coding=utf-8
#The Credit For This Code Goes To KemyBadshah404
...
logo = """
  ...
  /033[0;92m        _                 _______  _______ _________ _       
| \    /\|\     /|(       )(  ___  )\__   __/( \      
|  \  / /| )   ( || () () || (   ) |   ) (   | (      
|  (_/ / | |   | || || || || (___) |   | |   | |      
|   _ (  | |   | || |(_)| ||  ___  |   | |   | |      
...
CorrectUsername = "KemyBadshah"
CorrectPassword = "Dhorlo"
...
while (loop == 'true'):
    ...
    if (username == CorrectUsername):
        ...
        if (password == CorrectPassword):
            print "Logged in successfully as " + username #Dev:Kemy_Badshah
	    time.sleep(2)
            loop = 'false'
        else:
...
def menu():
	...
	try:
		...
		keluar()
	os.system("clear") #Dev:Kemy_Badshah
	print logo
...
def pilih_super():
	...
	p.map(main, id)
	print "\033[1;95m♡──────────•◈•──────────♡\033[1;96mBlackCoder\033[1;95m♡──────────•◈•──────────♡"
	print "  \033[1;93m«---•◈•---Developed By love---•◈•---»" #Dev:Kemy_Badshah
	...
	print """
             ...
             ◥⊙▲⊙▲⊙▲⊙▲⊙▲⊙◤
♡──────────────•◈•──────────────♡.
: \033[1;96m .....Kemy Badshah........... \033[1;93m :
♡──────────────•◈•──────────────♡.' 
                whatsapp Num
               +923000000000"""
